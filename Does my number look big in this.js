...
// My Solution
// 1- Convert Value to Array 
// 2- Take all Integers and Power it to Number of digit of Array
// 3- Create SumValue variable 
// 4- Sum all  Powers 
// 5- Check if Sum all values == Value return True 
// 6- Check if Sum all values !== Value return False 

function narcissistic(value) {
    let arr = value.toString().split("")
    let sum = 0;
    for (let i = 0; i < arr.length; i++) {
        sum = arr[i] ** arr.length + sum
