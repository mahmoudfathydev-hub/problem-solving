...
// is coded as ·−−−−. The Morse code is case-insensitive, traditionally capital letters are used. 
...
decodeMorse = function (morseCode) {
    return morseCode.trim().split("   ").map(w => w.split(" ").map(c => MORSE_CODE[c]).join("")).join(" ")
}